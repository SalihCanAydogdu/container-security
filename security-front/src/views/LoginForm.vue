<template>
  <div class="login-background">
    <div class="login-container">
      <img src="@/assets/x_audit_logo.png" alt="X Audit Logo" class="logo"/>
      <h1>Giriş Yap</h1>
...
<script>
import api from '@/api/axiosInstance'; // Kendi oluşturduğun instance'ı çağır
  ...
  setup() {
    ...
    const verifyCode = async () => {
      try {
        ...
        // JWT artık HTTP-Only Cookie'de saklanacak, localStorage'a kaydetmeye gerek yok
